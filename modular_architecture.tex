...
But this is not always the case as shown in \fullref{sec:Architectures}.There are cases where microservices are the best choice and there are cases where miniservices or a modular monolith is the best choice. This chapter will compare the three architectures and decide which architecture fits best with EFFE. This will be done with the help of chapter \fullref{sec:IsoRecap}
...
\fullref{sec:Scalability} the obvious winner was microservices. In second place was miniservices and last was modular monolith. The quality attribute applicable is \textbf{performance}.
